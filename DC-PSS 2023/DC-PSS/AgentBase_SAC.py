...
class AgentBase_SAC:  # [ElegantRL.2021.11.11]
    def __init__(self, net_dim=256, state_dim=8, action_dim=2, reward_scale=1.0, gamma=0.99,
                 learning_rate=1e-4, if_per_or_gae=False, env_num=1, gpu_id=0, num_agents=2, maddpg_params=None):
        """initialize
    ...
    def init(self, net_dim=256, state_dim=8, action_dim=2, reward_scale=1.0, gamma=0.99,
        ...
        self.act_optim = torch.optim.Adam(self.act.parameters(), learning_rate / 50) if self.ClassAct else self.cri
    ...
    def save_or_load_agent(self, cwd: str, if_save: bool):
        ...
        name_obj_list = [('actor_sac', self.act), ('act_sac_target', self.act_target), ('act_sac_optim', self.act_optim),
                         ('critic_sac', self.cri), ('cri_sac_target', self.cri_target), ('cri_sac_optim', self.cri_optim), ]
