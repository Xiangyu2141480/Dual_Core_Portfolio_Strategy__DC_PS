...
class Arguments:  # [ElegantRL.2021.10.21]
    ...
    """
    def __init__(self, env, env_test, agent):
        ...
        if self.if_off_policy:  # off-policy
            ...
            self.repeat_times = 1000  # collect target_step, then update network
        ...
        self.learner_gpus = (0, 1, 2, 3)  # for example: os.environ['CUDA_VISIBLE_DEVICES'] = '0, 2,'
        ...
        self.eval_test_env = None
        self.eval_gap = 2 ** 80  # evaluate the agent per eval_gap seconds
        self.eval_times1 = 2 ** 0  # number of times that get episode return in first
        self.eval_times2 = 2 ** 1  # number of times that get episode return in second
    ...
    def init_before_training(self):
        ...
        torch.manual_seed(self.random_seed)
        # torch.svd_lowrank(self.random_seed)
