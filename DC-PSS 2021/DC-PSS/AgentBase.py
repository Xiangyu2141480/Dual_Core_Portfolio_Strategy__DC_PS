...
class AgentBase:  # [ElegantRL.2021.11.11]
    ...
    def save_or_load_agent(self, cwd: str, if_save: bool):
        ...
        name_obj_list = [('actor_ddpg', self.act), ('act_ddpg_target', self.act_target), ('act_ddpg_optim', self.act_optim),
                         ('critic_ddpg', self.cri), ('cri_ddpg_target', self.cri_target), ('cri_ddpg_optim', self.cri_optim), ]
