...
eposide_return_DDPG_FinRL, return_mean_DDPG_FinRL, variance_DDPG_FinRL, sharpe_ratio_DDPG_FinRL, output_data_list_FinRL = mean_and_variance_calculation(episode_total_assets, "DDPG-FinRL")
