...
class YahooFinanceProcessor:
    ...
    def get_trading_days(self, start, end):
        # xshg = tc.get_calendar("XSHG")
        # xyse = tc.get_calendar("XNYS")  # New York Stock Exchange
        # xhkg = tc.get_calendar("XHKG")  # Hong Kong Stock Exchange
        nyse = tc.get_calendar("NYSE")

        name_list = tc.get_calendar_names(include_aliases=False)
